...
export const blocksFeature = createFeature({
  ...
  reducer: createReducer(
    ...
    on(BlocksActions.loadBlocksSuccess, (state, { items }) => ({
      ...state,
      items,
    ...
    on(BlocksActions.setFilters, (state, { filters }) => ({
      ...state,
      filters: { ...state.filters, ...filters },
    })),

    on(BlocksActions.loadBlockDetail, (state) => ({
      ...state,
      detailStatus: 'loading' as const,
      detailErrorMessageKey: null,
    })),
    on(BlocksActions.loadBlockDetailSuccess, (state, { block }) => ({
      ...state,
      selected: block,
    ...
    on(BlocksActions.loadBlockDetailFailure, (state, { errorMessageKey }) => ({
      ...
      detailErrorMessageKey: errorMessageKey,
    })),
    on(BlocksActions.clearBlockDetail, (state) => ({
      ...state,
      selected: null,
